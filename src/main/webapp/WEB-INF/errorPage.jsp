...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/404style/bootstrap.min.css">
    <link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/404style/style.css">
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-6 align-self-center">
                ...
                <a href="toLogin"><button class="btn green">返回首页</button></a>
            </div>
        </div>
    </div>
</main>

<script src="${pageContext.request.contextPath}/404style/gsap.min.js"></script>
<script src="${pageContext.request.contextPath}/404style/script.js"></script>
