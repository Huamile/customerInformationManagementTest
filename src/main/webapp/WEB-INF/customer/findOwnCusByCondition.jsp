...
<form id="updateBox" class="layui-form layui-form-pane" style="display: none;margin-top: 20px;margin-left: 80px">
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-inline">
            <select name="contact" id="contact" lay-verify="required" lay-search>
            </select>
        </div>
    </div>
            ...
            $.post("ensureRole",{},function (data) {
                ...
                if (2 == i){
                    $.post("backEmp",{},function (data) {
                        ...
                        $("#contactReload").siblings("div.layui-form-select").find('dl').find(select).click();
        ...
        var active = {
            reload: function(){
                ...
                table.reload('conditionTable', {
                    ...
                    ,url: '${pageContext.request.contextPath}/backOwnCusByCondition'
                });
            }
        };
