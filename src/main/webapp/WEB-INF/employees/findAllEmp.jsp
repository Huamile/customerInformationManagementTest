...
<form id="insertBox" class="layui-form layui-form-pane" style="display: none;margin-top: 20px;margin-left: 80px">
    <div class="layui-form-item">
        ...
        <div class="layui-input-inline">
            <input type="text" name="emploginname" id="loginname" required  lay-verify="required|username" placeholder="请输入用户登入名" autocomplete="off" class="layui-input">
        </div>
        <div class="layui-form-mid layui-word-aux" id="inserttip"></div>
    </div>
    <div class="layui-form-item">
        <label class="layui-form-label">密码</label>
        <div class="layui-input-inline">
            <input type="password" name="emppassword" id="password" <%--lay-verify="pass"--%> placeholder="请输入密码" autocomplete="off" class="layui-input">
        </div>
    </div>
    <div class="layui-form-item">
        <label class="layui-form-label">联系电话</label>
        <div class="layui-input-inline">
            <input type="text" name="emptel" id="tel" required  lay-verify="required|tel" placeholder="请输入联系电话" autocomplete="off" class="layui-input">
        </div>
    </div>
    <div class="layui-form-item">
        <label class="layui-form-label">用户姓名</label>
        <div class="layui-input-inline">
            <input type="text" name="empname" id="name" required  lay-verify="required|username" placeholder="请输入用户姓名" autocomplete="off" class="layui-input">
        </div>
    </div>
    <div class="layui-form-item">
        <label class="layui-form-label">邮箱</label>
        <div class="layui-input-inline">
            <input type="text" name="empemail" id="email" required  lay-verify="required|mail" placeholder="请输入邮箱" autocomplete="off" class="layui-input">
        </div>
    </div>
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-inline">
            <select name="roleid" id="rid" lay-verify="required">
                <option value=""></option>
    ...
    layui.use(['table','element','form','jquery','layer'], function(){
        ...
        $("#loginname").on('blur',function () {
            $.ajax({
                ...
                success:function (data) {
                    $("#inserttip").html("重名验证结果："+data.msg);
                    if (data.msg == "重名"){
                        $("#loginname").val("");
                    }
                }
        ...
        table.render({
            ...
            ,cols: [[ //表头
                ...
                ,{field: 'emptel', title: '联系电话', sort: true,align:'center'}
